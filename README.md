...
This is a web-based application that reads RSS feeds. Jasmine framework is used to write and run tests.


## Installing

User needs to open index.html file in any browser.
